...
## [OnBoarding](https://github.com/hiroyuki0402/public-experiment-ios/tree/develop/SwiftUI/OnBoarding)

iOS 26のLiquid Glass APIを活用したオンボーディング画面を作ってみるためのプロジェクト。
デバイスフレーム風ベゼル付きのスクリーンショットをページングで表示
画像はURL優先でnilや失敗時はアセットにフォールバックする設計で、ConcentricRectangleやglassProminent/glassボタンスタイル使い方を再確認するためのやつ

## [SideBar](https://github.com/hiroyuki0402/public-experiment-ios/tree/develop/SwiftUI/SideBar)

X風のスライド式サイドメニュー
左端スワイプでサイドメニューが開いてメインコンテンツが右にスライドするやつで、UIPanGestureRecognizerをUIGestureRecognizerRepresentableでラップしてScrollViewとの
